...
分享链接与 Clash 转换支持 Shadowsocks（含 SIP002 插件）、VMess、VLESS/Reality、Trojan、Hysteria、Hysteria2、TUIC、AnyTLS，以及 Clash 中的 SOCKS/HTTP 节点。可保留 WS、HTTP/H2、HTTPUpgrade、QUIC、gRPC、SNI、ALPN、uTLS 指纹、Reality、混淆、带宽、端口跳跃、UDP 转发、0-RTT 与心跳等常用参数。
